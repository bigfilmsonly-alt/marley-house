...
export const stories: Story[] = [
  ...
  },
  {
    id: 'the-fire-teaches',
    room: 'fire',
    title: 'The Fire Teaches',
    body: 'Carrying a name larger than yourself is its own weight. The fear was never failure. It was being remembered for the wrong thing.',
    kind: 'reflection',
  },
  {
    id: 'survival-is-quiet',
    room: 'fire',
    title: 'Survival Is Quiet',
    body: 'Survival is quieter than fame. It is waking up the day after the storm and opening the door anyway.',
    kind: 'lesson',
  },
  {
    id: 'mountain-to-cup',
    room: 'coffee',
    title: 'Mountain to Cup',
    body: 'From the Blue Mountains to the cup in your hand — every bean remembers the soil, the rain, and the hands that picked it. That is what you taste.',
    kind: 'reflection',
  },
  {
    id: 'the-frequency',
    room: 'music',
    title: 'The Frequency',
    body: 'One good song outlives the person who wrote it. That is not death — that is frequency. The vibration continues long after the instrument is set down.',
    kind: 'reflection',
  },
  {
    id: 'what-the-fire-left',
    room: 'wisdom',
    title: 'What the Fire Left',
    body: 'Every wrong turn cost something. None of them were wasted. The house was built from the broken pieces.',
    kind: 'lesson',
  },
];
