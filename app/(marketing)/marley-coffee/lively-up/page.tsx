...
const blend = products.find((p) => p.id === 'lively-up')!;
const SITE = 'https://marley-house.vercel.app';
const others = products.filter((p) => p.id !== blend.id);

export const metadata: Metadata = {
  title: 'Lively Up — Bold Dark Roast | Marley Coffee',
  description:
    'Lively Up is a bold dark roast blend with chocolate and subtle citrus notes. Fairtrade certified, full-throttle flavor by Marley Coffee.',
  alternates: { canonical: `${SITE}/marley-coffee/lively-up` },
  openGraph: {
    title: 'Lively Up — Marley Coffee',
    description: 'Dark roast. Bold chocolate with a surprising citrus finish.',
    url: `${SITE}/marley-coffee/lively-up`,
    images: [{ url: '/og-image.png', width: 1200, height: 630 }],
  },
};

export default function LivelyUpPage() {
  return (
    <article className="max-w-3xl mx-auto px-6 py-16">
      <header className="text-center mb-14">
        ...
        <p className="max-w-xl mx-auto text-[var(--cream)] leading-relaxed">
          Lively Up is a full-throttle dark roast blend from Marley Coffee.
          Bold chocolate meets a surprising citrus finish in this Fairtrade
          certified blend built for those who need no introduction. Unlock
          hidden citrus notes with a 24-hour cold brew.
        </p>
      </header>
