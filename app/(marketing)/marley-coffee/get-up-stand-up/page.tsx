...
const blend = products.find((p) => p.id === 'get-up-stand-up')!;
const SITE = 'https://marley-house.vercel.app';
const others = products.filter((p) => p.id !== blend.id);

export const metadata: Metadata = {
  title: 'Get Up, Stand Up — Light Roast Blend | Marley Coffee',
  description:
    'Get Up, Stand Up is a light-roast blend with bright, nutty, caramel notes. Fairtrade certified and ethically sourced by Marley Coffee.',
  alternates: { canonical: `${SITE}/marley-coffee/get-up-stand-up` },
  openGraph: {
    title: 'Get Up, Stand Up — Marley Coffee',
    description: 'Light roast blend. Bright, nutty, caramel notes.',
    url: `${SITE}/marley-coffee/get-up-stand-up`,
    images: [{ url: '/og-image.png', width: 1200, height: 630 }],
  },
};

export default function GetUpStandUpPage() {
  return (
    <article className="max-w-3xl mx-auto px-6 py-16">
      <header className="text-center mb-14">
        ...
        <p className="max-w-xl mx-auto text-[var(--cream)] leading-relaxed">
          Get Up, Stand Up is a light-roast blend from Marley Coffee featuring
          bright, nutty, and caramel notes. Fairtrade certified and roasted
          to preserve delicate flavors, this uplifting blend starts your day
