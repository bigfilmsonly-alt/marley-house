...
const blend = products.find((p) => p.id === 'buffalo-soldier')!;
const SITE = 'https://marley-house.vercel.app';
const others = products.filter((p) => p.id !== blend.id);

export const metadata: Metadata = {
  title: 'Buffalo Soldier — Medium-Dark Roast | Marley Coffee',
  description:
    'Buffalo Soldier is a bold, medium-dark roast blend with rich, dark chocolate notes. Fairtrade certified and full-bodied by Marley Coffee.',
  alternates: { canonical: `${SITE}/marley-coffee/buffalo-soldier` },
  openGraph: {
    title: 'Buffalo Soldier — Marley Coffee',
    description: 'Medium-dark roast. Rich, full-bodied, dark chocolate notes.',
    url: `${SITE}/marley-coffee/buffalo-soldier`,
    images: [{ url: '/og-image.png', width: 1200, height: 630 }],
  },
};

export default function BuffaloSoldierPage() {
  return (
    <article className="max-w-3xl mx-auto px-6 py-16">
      <header className="text-center mb-14">
        ...
        <p className="max-w-xl mx-auto text-[var(--cream)] leading-relaxed">
          Buffalo Soldier is a bold, medium-dark roast blend from Marley Coffee.
          Featuring rich, full-bodied character and deep dark chocolate notes,
          this fearless blend is Fairtrade certified and crafted for those who
          take their coffee with backbone.
        </p>
      </header>
