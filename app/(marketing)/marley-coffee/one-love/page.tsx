...
const blend = products.find((p) => p.id === 'one-love')!;
const SITE = 'https://marley-house.vercel.app';
const others = products.filter((p) => p.id !== blend.id);

export const metadata: Metadata = {
  title: 'One Love — 100% Ethiopian Single Origin | Marley Coffee',
  description:
    'One Love is a medium-roast, 100% Ethiopian single-origin coffee. Smooth, balanced, and universally loved. Fairtrade certified by Marley Coffee.',
  alternates: { canonical: `${SITE}/marley-coffee/one-love` },
  openGraph: {
    title: 'One Love — Marley Coffee',
    description: 'Medium roast. 100% Ethiopian single origin. Smooth and balanced.',
    url: `${SITE}/marley-coffee/one-love`,
    images: [{ url: '/og-image.png', width: 1200, height: 630 }],
  },
};

export default function OneLovePage() {
  return (
    <article className="max-w-3xl mx-auto px-6 py-16">
      <header className="text-center mb-14">
        ...
        <p className="max-w-xl mx-auto text-[var(--cream)] leading-relaxed">
          One Love is a medium-roast, 100% Ethiopian single-origin coffee by
          Marley Coffee. Grown at 1,800-2,200 meters in Sidamo, Ethiopia, it
          delivers smooth balance, exotic complexity, and a sweet finish.
          Fairtrade certified and universally loved.
        </p>
      </header>
