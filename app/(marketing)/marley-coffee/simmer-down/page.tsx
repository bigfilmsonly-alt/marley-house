...
const blend = products.find((p) => p.id === 'simmer-down')!;
const SITE = 'https://marley-house.vercel.app';
const others = products.filter((p) => p.id !== blend.id);

export const metadata: Metadata = {
  title: 'Simmer Down — Swiss Water Decaf | Marley Coffee',
  description:
    'Simmer Down is a Swiss Water Process decaf blend with balanced cocoa notes. All the ritual, none of the buzz. Fairtrade certified by Marley Coffee.',
  alternates: { canonical: `${SITE}/marley-coffee/simmer-down` },
  openGraph: {
    title: 'Simmer Down — Marley Coffee',
    description: 'Swiss Water Process decaf. Balanced, cocoa notes, zero compromise.',
    url: `${SITE}/marley-coffee/simmer-down`,
    images: [{ url: '/og-image.png', width: 1200, height: 630 }],
  },
};

export default function SimmerDownPage() {
  return (
    <article className="max-w-3xl mx-auto px-6 py-16">
      <header className="text-center mb-14">
        ...
        <p className="max-w-xl mx-auto text-[var(--cream)] leading-relaxed">
          Simmer Down is a Swiss Water Process decaf blend from Marley Coffee.
          Balanced with hints of cocoa and zero caffeine, this Fairtrade
          certified blend refuses to compromise on flavor. All the ritual and
          depth of great coffee, none of the buzz.
        </p>
      </header>
