...
const rooms = [
  ...
  { slug: 'fire', name: 'Fire', color: '#E8C23A', count: stories.filter(s => s.room === 'fire').length + wisdomCards.filter(w => w.room === 'fire').length },
  ...
  { slug: 'movement', name: 'Movement', color: '#E8C23A', count: 0 },
